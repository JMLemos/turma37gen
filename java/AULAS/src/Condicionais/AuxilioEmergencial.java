	...
	public static void main(String[] args) {
		...
		if (outroAuxilio == 'S') {
			...
			if(pronome == 'O') {	
				...
				auxilioChefa = (AUXILIO + (VALORFILHO * qtdFilhos));
				System.out.println("Olá, " + nome + " o valor que o Senhor vai receber é de R$" + auxilioChefa);
				}
			else if (pronome == 'E') {
				System.out.print("Quantos filhos você tem? ");
				qtdFilhos = leia.nextInt();
				...
				auxilioChefa = (AUXILIO + (VALORFILHO * qtdFilhos));
				System.out.println("Olá, " + nome + " o valor que Senhore vai receber é de R$" + auxilioChefa);
			}
			else if (pronome == 'A'){
				...
				chefaFamilia = leia.next().toUpperCase().charAt(0);
					...
					if (chefaFamilia == 'S') {
						...
						System.out.println("Olá, " + nome + " o valor que a Senhora vai receber é de R$" + auxilioChefa);	
