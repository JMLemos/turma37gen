...
public class Lista03Exe04 {
	...
	public static void main(String[] args) {
		...
		int pessoaCalma=0, mulherNervosa=0, homemAgressivo=0, outrosCalmos=0, nervosesMaiorQuarenta=0, calmesMenorDezoito=0;
		...
		System.out.println("QUANTIDADE DE NERVOSES MAIOR DE 40 ANOS: " + nervosesMaiorQuarenta);
